...
weatherConditions.open(
  "GET",
  "//api.openweathermap.org/data/2.5/weather?zip=10027,us&appid=57ce6ee99d3739461ccfe67811d31612&units=imperial",
  true
);
...
weatherForecast.open(
  "GET",
  "//api.openweathermap.org/data/2.5/forecast?zip=10027,us&appid=57ce6ee99d3739461ccfe67811d31612&units=imperial",
  true
);
